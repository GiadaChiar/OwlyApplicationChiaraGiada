...
export function createDom(data, resultsDiv) {
    ...
    if (data.numFound == 0) {
        ...
        data.docs.forEach(doc => {
            ...
            let titleElement = createElements({
                tag: 'a', className: 'book-title btn btn-primary', textContent: doc.title ?? "Title not available", parentElement: insideRowDiv, attributes: {
